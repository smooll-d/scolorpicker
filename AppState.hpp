...
struct AppState
{
    ...
    void CreateCursor()
    {
        ...
        {
            // TODO: Check bigger sizes on 100% scaling
    ...
    void CreateWindowIcon()
    {
        ...
        {
            // TODO: Check bigger sizes on 100% scaling
            Utils::CreateSurfaceFromSTBI(std::format("{}/logo/logo_16x16.png", cli.cwd)),
            Utils::CreateSurfaceFromSTBI(std::format("{}/logo/logo_32x32.png", cli.cwd)),
            Utils::CreateSurfaceFromSTBI(std::format("{}/logo/logo_64x64.png", cli.cwd)),
            Utils::CreateSurfaceFromSTBI(std::format("{}/logo/logo_128x128.png", cli.cwd))
        }
        ...
        for (int i = 1; i < 4; i++)
        {
            if (!SDL_AddSurfaceAlternateImage(iconSurfaces[0], iconSurface[i]))
            {
